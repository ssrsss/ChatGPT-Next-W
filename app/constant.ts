...
export const OPENAI_BASE_URL = "https://oneapi.yjie.fun/";
...
export const SUMMARIZE_MODEL = "ChatGPT-3.5-问答模型";

export const KnowledgeCutOffDate: Record<string, string> = {
  default: "2021-09",
  "gpt-3.5-turbo-0125": "2023-04",
