...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "> ✅`2024/4/25前`购买过的客户key因误删数据库.\n导致令牌无效，请联系企业客服：[立即微信扫码添加](https://zfb.yjie.fun/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20240426191701.jpg)，提供前期令牌免费补卡并返还前期已使用额度，对您带来的不便深表歉意！\n\n> ⚡️您的卡号似乎未正确填写或错误：[立即查看](/#/auth)\n- 额度充值卡购买(1元200万对话字数)：[立即购买](http://bj.yjie.fun/gm/)\n授权后请重新提问~",
  },
  Auth: {
    Title: "设备未授权",
